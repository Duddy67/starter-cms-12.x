...
// Groups
Route::middleware(['admin.users.groups'])->group(function () {
...
// Roles
Route::middleware(['admin.users.roles'])->group(function () {
...
// Permissions
Route::middleware(['admin.users.permissions'])->group(function () {
